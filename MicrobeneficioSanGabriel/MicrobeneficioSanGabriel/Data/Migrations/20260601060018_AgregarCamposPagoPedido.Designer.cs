...
namespace MicrobeneficioSanGabriel.Data.Migrations
{
    ...
    [Migration("20260601060018_AgregarCamposPagoPedido")]
    partial class AgregarCamposPagoPedido
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.MetodoPago", b =>
                {
                    b.Property<int?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.MovimientoInventario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.Produccion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.RegistroFinanciero", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.Trazabilidad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.Factura", b =>
                {
                    b.HasOne("MicrobeneficioSanGabriel.Models.Pedido", "Pedido")
                        .WithMany()
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.Produccion", b =>
                {
                    b.HasOne("MicrobeneficioSanGabriel.Models.Lote", "Lote")
                        .WithMany()
            ...
            modelBuilder.Entity("MicrobeneficioSanGabriel.Models.Trazabilidad", b =>
                {
                    ...
                    b.HasOne("MicrobeneficioSanGabriel.Models.Produccion", "Produccion")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MicrobeneficioSanGabriel.Models.ApplicationUser", null)
                        .WithMany()
